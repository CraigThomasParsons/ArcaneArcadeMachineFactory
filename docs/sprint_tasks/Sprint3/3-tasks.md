...
- deliver first integrated slice for Godot Bridge Runtime
- prove the architecture works in practice

## Context

This is the first end-to-end implementation segment focused on surface factory state and events inside the game.
